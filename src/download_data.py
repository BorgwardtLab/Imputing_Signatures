...
UEA_dir = data_dir + 'Multivariate_ts'
...
if not os.path.exists(UEA_dir): # check if UEA directory exists, if not download the UEA archive
    url = 'https://www.timeseriesclassification.com/Downloads/Archives/Multivariate2018_ts.zip' #'https://www.timeseriesclassification.com/Downloads/Archives/Multivariate2018_arff.zip' 
