...
`interprets' the raw data for downstream classification tasks. In Section~\ref{sec:Fragile dependence} we further motivate the need for assessing the path construction by showing that a single imputed value can affect the area which is computed with the signature. 
